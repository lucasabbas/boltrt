...
__lua_Thread = _hx_e()
__lucidKit_ui_Widget = _hx_e()
__lucidEd_EditorWindow = _hx_e()
__lucidKit_App = _hx_e()
__lucidEd_Main = _hx_e()
...
__lucidKit_ui_Widget.new = function(ioCore,parentNode) 
  local self = _hx_new(__lucidKit_ui_Widget.prototype)
  __lucidKit_ui_Widget.super(self,ioCore,parentNode)
  return self
end
__lucidKit_ui_Widget.super = function(self,ioCore,parentNode) 
  self.document = gdx.UiDocument.__new();
  self.ioCore = ioCore;
  parentNode:addChild(self.document);
  self:init();
end
__lucidKit_ui_Widget.__name__ = true
__lucidKit_ui_Widget.prototype = _hx_e();
__lucidKit_ui_Widget.prototype.init = function(self) 
end
__lucidKit_ui_Widget.prototype.stop = function(self) 
end
__lucidKit_ui_Widget.prototype.free = function(self) 
  self:stop();
  self.document:queueFree();
end

__lucidKit_ui_Widget.prototype.__class__ =  __lucidKit_ui_Widget

__lucidEd_EditorWindow.new = function(ioCore,parentNode) 
  local self = _hx_new(__lucidEd_EditorWindow.prototype)
  __lucidEd_EditorWindow.super(self,ioCore,parentNode)
  return self
end
__lucidEd_EditorWindow.super = function(self,ioCore,parentNode) 
  __lucidKit_ui_Widget.super(self,ioCore,parentNode);
end
__lucidEd_EditorWindow.__name__ = true
__lucidEd_EditorWindow.prototype = _hx_e();
__lucidEd_EditorWindow.prototype.init = function(self) 
  self.document:loadFromPath("data://editorWindow.xml", self.ioCore);
end

__lucidEd_EditorWindow.prototype.__class__ =  __lucidEd_EditorWindow
__lucidEd_EditorWindow.__super__ = __lucidKit_ui_Widget
setmetatable(__lucidEd_EditorWindow.prototype,{__index=__lucidKit_ui_Widget.prototype})
...
__lucidEd_Main.new = function() 
  local self = _hx_new(__lucidEd_Main.prototype)
  __lucidEd_Main.super(self)
  return self
end
__lucidEd_Main.super = function(self) 
  __lucidKit_App.super(self);
end
__lucidEd_Main.__name__ = true
__lucidEd_Main.main = function() 
  __lucidEd_Main.new();
end
...
__lucidEd_Main.prototype.__class__ =  __lucidEd_Main
__lucidEd_Main.__super__ = __lucidKit_App
setmetatable(__lucidEd_Main.prototype,{__index=__lucidKit_App.prototype})

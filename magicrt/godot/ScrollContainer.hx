...
class ScrollContainerPauseMode {
    public static var Inherit: Int = 0;
    public static var Stop: Int = 1;
    public static var Process: Int = 2;
}
class ScrollContainerPhysicsInterpolationMode {
    public static var Inherit: Int = 0;
    public static var Off: Int = 1;
    public static var On: Int = 2;
}
class ScrollContainerSignalNames {
    public static var scrollEnded: String = "scroll_ended";
    public static var scrollStarted: String = "scroll_started";
}

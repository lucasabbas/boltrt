...
extern class Node extends Object {
    ...
    public function rpcId(peerId: Int, method: String): Variant;
    public function rpcUnreliable(method: String): Variant;
    public function rpcUnreliableId(peerId: Int, method: String): Variant;
    public function rset(property: String, value: Variant): Void;
    public function rsetConfig(property: String, mode: Int): Void;
    public function rsetId(peerId: Int, property: String, value: Variant): Void;
    public function rsetUnreliable(property: String, value: Variant): Void;
    public function rsetUnreliableId(peerId: Int, property: String, value: Variant): Void;

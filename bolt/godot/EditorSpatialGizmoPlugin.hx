...
extern class EditorSpatialGizmoPlugin extends Resource {
    ...
    public function commitHandle(gizmo: EditorSpatialGizmo, index: Int, restore: Dynamic, cancel: Bool = false): Void;
    ...
    public function getHandleValue(gizmo: EditorSpatialGizmo, index: Int): Dynamic;

...
class AcceptDialogPauseMode {
    public static var Inherit: Int = 0;
    public static var Stop: Int = 1;
    public static var Process: Int = 2;
}
class AcceptDialogPhysicsInterpolationMode {
    public static var Inherit: Int = 0;
    public static var Off: Int = 1;
    public static var On: Int = 2;
}
class AcceptDialogSignalNames {
    public static var confirmed: String = "confirmed";
    public static var customAction: String = "custom_action";
}

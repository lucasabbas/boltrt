...
extern class Control extends CanvasItem {
    ...
    public function canDropData(position: GdVector2, data: Dynamic): Bool;
    public function dropData(position: GdVector2, data: Dynamic): Void;
    public function findNextValidFocus(): Control;
    public function findPrevValidFocus(): Control;
    public function forceDrag(data: Dynamic, preview: Control): Void;
    ...
    public function getDragData(position: GdVector2): Dynamic;

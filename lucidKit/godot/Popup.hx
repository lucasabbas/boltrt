...
class PopupMouseDefaultCursorShape {
...
class PopupPauseMode {
    public static var Inherit: Int = 0;
    public static var Stop: Int = 1;
    public static var Process: Int = 2;
}
class PopupPhysicsInterpolationMode {
    public static var Inherit: Int = 0;
    public static var Off: Int = 1;
    public static var On: Int = 2;
}
class PopupSignalNames {
    public static var aboutToShow: String = "about_to_show";
    public static var popupHide: String = "popup_hide";
}
@:native("godot.Popup")

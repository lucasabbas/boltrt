...
class AspectRatioContainerStretchMode {
    public static var WidthControlsHeight: Int = 0;
    public static var HeightControlsWidth: Int = 1;
    public static var Fit: Int = 2;
    public static var Cover: Int = 3;
}
class AspectRatioContainerAlignmentHorizontal {
    public static var Begin: Int = 0;
    public static var Center: Int = 1;
    public static var End: Int = 2;
}
class AspectRatioContainerAlignmentVertical {
    public static var Begin: Int = 0;
    public static var Center: Int = 1;
    public static var End: Int = 2;
}
class AspectRatioContainerGrowHorizontal {
    public static var Begin: Int = 0;
    public static var End: Int = 1;
    public static var Both: Int = 2;
}
class AspectRatioContainerGrowVertical {
    public static var Begin: Int = 0;
    public static var End: Int = 1;
    public static var Both: Int = 2;
}
class AspectRatioContainerFocusMode {
    public static var None: Int = 0;
    public static var Click: Int = 1;
    public static var All: Int = 2;
}
class AspectRatioContainerMouseFilter {
    public static var Stop: Int = 0;
    public static var Pass: Int = 1;
    public static var Ignore: Int = 2;
}
class AspectRatioContainerMouseDefaultCursorShape {
...
class AspectRatioContainerPauseMode {
    public static var Inherit: Int = 0;
    public static var Stop: Int = 1;
    public static var Process: Int = 2;
}
class AspectRatioContainerPhysicsInterpolationMode {
    public static var Inherit: Int = 0;
    public static var Off: Int = 1;
    public static var On: Int = 2;
}
class AspectRatioContainerSignalNames {
}

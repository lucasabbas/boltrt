...
__boltEd_EditorWindow.prototype.init = function(self) 
  ...
  local fileMenu = self.fileMenuButton:getPopup();
  local editMenu = self.editMenuButton:getPopup();
  local helpMenu = self.helpMenuButton:getPopup();
  godot.SignalToFunc.connect(fileMenu, __bolt_godot_PopupMenuSignalNames.idPressed, function(id) 
    _G.print(Std.string(Std.string("id: ") .. Std.string(id)));
    if (id == 0) then 
      _gthis:onNewProject();
    else
      if (id == 1) then 
...
__boltEd_Explorer.prototype.buildRoot = function(self) 
  ...
  root.dirName = self.editorWindow.projectName;
  if (root == nil) then 
...
__boltEd_Main.prototype.init = function(self) 
  local _hx_status, _hx_result = pcall(function() 
      ...
      _G.print(Std.string(Std.string("Mono version: ") .. Std.string(__mono__.version)));
      _G.print(Std.string(Std.string("Mono platform: ") .. Std.string(__mono__.platform)));
      _G.print(Std.string(Std.string("Mono runtime version: ") .. Std.string(__mono__.runtimeVersion)));
      _G.print(Std.string(Std.string("Mono framework version: ") .. Std.string(__mono__.frameworkVersion)));
      _G.print(Std.string(Std.string("Mono runtime identifier: ") .. Std.string(__mono__.runtimeIdentifier)));
      _G.print(Std.string(Std.string("Mono cpu architecture: ") .. Std.string(__mono__.cpuArchitecture)));
      _G.print(Std.string(Std.string("Mono operating system: ") .. Std.string(__mono__.operatingSystem)));
    return _hx_pcall_default
  end)
  if not _hx_status and _hx_result == "_hx_pcall_break" then
  elseif not _hx_status then 
    local _g = _hx_result;
    local e = __haxe_Exception.caught(_g);
    local v = Std.string(Std.string("Error: ") .. Std.string(Std.string(e))) .. Std.string(" ");
    local tmp = e:get_stack();
    _G.print(Std.string(Std.string(v) .. Std.string(((function() 
      local _hx_1
      if (tmp == nil) then 
      _hx_1 = "null"; else 
      _hx_1 = _hx_wrap_if_string_field(__haxe__CallStack_CallStack_Impl_,'toString')(tmp); end
      return _hx_1
    end )()))));
  elseif _hx_result ~= _hx_pcall_default then
    return _hx_result

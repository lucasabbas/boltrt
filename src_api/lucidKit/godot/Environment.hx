...
extern class Environment extends Resource {
    ...
    public var glow_levels__1: Bool;
    public var glow_levels__2: Bool;
    public var glow_levels__3: Bool;
    public var glow_levels__4: Bool;
    public var glow_levels__5: Bool;
    public var glow_levels__6: Bool;
    public var glow_levels__7: Bool;

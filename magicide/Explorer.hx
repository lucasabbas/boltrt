...
import magicrt.godot.Tree;
import magicrt.godot.TreeItem;
import magicrt.godot.ImageTexture;
import magicrt.godot.Image;
import magicide.explorer.DirIndex;
import magicide.explorer.FileIndex;
import magicrt.godot.AcceptDialog;
...
class Explorer {
    ...
    public function createTreeItemFromDirTree(dirIndex : DirIndex, parentItem : TreeItem = null) : Void {
        ...
        var projectIconFile = ioCore.loadBuffer("data://FugueIcons/icons/application-blue-magicrt.png");
